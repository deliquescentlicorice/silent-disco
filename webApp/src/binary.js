...
export binaryFeatures = binaryFeatures;
// exports.binaryFeatures = binaryFeatures;
export const BlobBuilder = window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder || window.BlobBuilder;
...
*/
export const BlobReadStream = BlobReadStream;
...
export const BinaryClient = BinaryClient;
